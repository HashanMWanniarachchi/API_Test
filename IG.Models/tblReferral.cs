...
namespace IG.Models
{
    ...
    public partial class tblReferral
    {
        ...
        public bool fldNoAssessment { get; set; }
        public Nullable<System.DateTime> fldInitialContactDate { get; set; }
        public bool fldInterpreterRequired { get; set; }
        ...
        public Nullable<System.Guid> fldHospital { get; set; }
        public Nullable<System.DateTime> fldDischargeDate { get; set; }
        public bool fldDVAReferral { get; set; }
        public string fldReferredByEmail { get; set; }
        public string fldReferralPeriodType { get; set; }
        public Nullable<int> fldReferralPeriod { get; set; }
        public bool fldReviewComplete { get; set; }
        public bool fldPhoneReview { get; set; }
        ...
        public Nullable<System.Guid> fldClientProgramId { get; set; }
        public Nullable<System.Guid> fldComPacksPackageID { get; set; }
        public Nullable<System.Guid> fldReferralPrimaryNeedID { get; set; }
        public string fldReferredByFax { get; set; }
        ...
        public Nullable<System.Guid> fldPrimaryReasonID { get; set; }
        public string fldReferringAgencyInvolvement { get; set; }
        public string fldFamilyInvolvementOtherServices { get; set; }
        public Nullable<int> fldMotherPregnant { get; set; }
        public Nullable<System.DateTime> fldBabyDueDate { get; set; }
    }
}
